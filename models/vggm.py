...
model_urls = {
    'vggm': 'http://data.lip6.fr/cadene/pretrainedmodels/vggm-786f2434.pth',
}
...
def vggm(pretrained=False, progress=True, **kwargs):
    model = VGGM(**kwargs)
    if pretrained:
       
        
        model.load_state_dict(model_zoo.load_url(model_urls['vggm']))
