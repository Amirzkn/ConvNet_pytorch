...
model_urls = {
    'pnasnet5large': 'http://data.lip6.fr/cadene/pretrainedmodels/pnasnet5large-bf079911.pth',
...
def pnasnet5large(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(model_urls['pnasnet5large']))
