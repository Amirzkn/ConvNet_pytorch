...
def initialize_pretrained_model(model, model_url):
   
    model.load_state_dict(model_zoo.load_url(model_urls[model_url]))
...
def senet154(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:        
        initialize_pretrained_model(model, 'senet154')
    return model
...
def se_resnet50(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        initialize_pretrained_model(model,'se_resnet50')
    return model
...
def se_resnet101(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        initialize_pretrained_model(model,'se_resnet101' )
    return model
...
def se_resnet152(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        initialize_pretrained_model(model,'se_resnet152')
    return model
...
def se_resnext50_32x4d(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        initialize_pretrained_model(model, 'se_resnext50_32x4d')
    return model
...
def se_resnext101_32x4d(pretrained=False, progress=True, **kwargs):
    ...
    if pretrained:
        ...
        initialize_pretrained_model(model,'se_resnext101_32x4d')
    return model
