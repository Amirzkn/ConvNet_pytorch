...
model_urls = {
    'dpn68':  'http://data.lip6.fr/cadene/pretrainedmodels/dpn68-4af7d88d2.pth',            
    'dpn68b': 'http://data.lip6.fr/cadene/pretrainedmodels/dpn68b_extra-363ab9c19.pth',
    'dpn92': None,
    'dpn98':  'http://data.lip6.fr/cadene/pretrainedmodels/dpn98-722954780.pth',
    'dpn131': 'http://data.lip6.fr/cadene/pretrainedmodels/dpn131-7af84be88.pth',
    'dpn107':  'http://data.lip6.fr/cadene/pretrainedmodels/dpn107_extra-b7f9f4cc9.pth',

}

def dpn68(pretrained=False, progress=True, **kwargs):
    model = DPN(
        small=True, num_init_features=10, k_r=128, groups=32,
        k_sec=(3, 4, 12, 3), inc_sec=(16, 32, 32, 64),
         test_time_pool=True, **kwargs)
    if pretrained:
       
        model.load_state_dict(model_zoo.load_url(model_urls['dpn68']))       
    return model

def dpn68b(pretrained=False, progress=True, **kwargs):
    model = DPN(
        small=True, num_init_features=10, k_r=128, groups=32,
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(model_urls['dpn68b']))       
    return model
...
def dpn98(pretrained=False, progress=True, **kwargs):
    model = DPN(
...
def dpn131(pretrained=False, progress=True, **kwargs):
    model = DPN(
...
def dpn107(pretrained=False, progress=True, **kwargs):
    model = DPN(
