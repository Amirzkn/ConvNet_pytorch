...
def nasnetamobile(pretrained=False, progress=True, **kwargs):
    r"""NASNetALarge model architecture from the
    `"NASNet" <https://arxiv.org/abs/1707.07012>`_ paper.
    """
    model = NASNetAMobile(**kwargs)
    if pretrained:       
        
        model.load_state_dict(model_zoo.load_url(model_urls['nasnetamobile'], map_location=None)) 
