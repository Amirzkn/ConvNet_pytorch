...
model_urls = {
    'polynet': 'http://data.lip6.fr/cadene/pretrainedmodels/polynet-f71d82a5.pth',
...
def polynet(pretrained=False, progress=True, **kwargs):
    """PolyNet architecture from the paper
    'PolyNet: A Pursuit of Structural Diversity in Very Deep Networks'
    https://arxiv.org/abs/1611.05725
    """
    model = PolyNet(**kwargs)
    if pretrained:
       
       
        model.load_state_dict(model_zoo.load_url(model_urls['polynet']))
