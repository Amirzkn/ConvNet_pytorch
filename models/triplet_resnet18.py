...
class Resnet18Triplet(nn.Module):
    ...
    def __init__(self, embedding_dimension=128,class_num=10, pretrained=False):
        ...
        self.extra_fc = nn.Linear(embedding_dimension, class_num)
    ...
    def forward(self, images):
        ...
        alpha = 0.1
        embedding_out = embedding * alpha
        class_out =  self.extra_fc(embedding)
        return embedding_out, class_out
